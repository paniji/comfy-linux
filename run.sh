...
#curl -X POST http://localhost:5000/prompt -H "Content-Type: application/json" -d '{"path":"https://cdn.pixabay.com/photo/2017/08/27/20/10/png-2687339_1280.png", "key":"d70297a8-e567-42bd-8ed6-7173b2daf30c"}'
